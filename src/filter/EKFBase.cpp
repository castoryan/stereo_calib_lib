...
void Prediction(Mat X_k, Mat U_k, Mat P_k, Mat Pn, Mat Q, Mat R_explicit, const EKFBase &EKFb, Mat &X_pred, Mat &P_pred, Mat &Z_explicit_pred, Mat &dF_dX, Mat &dH_dX, Mat &dF_dU, Mat &S){
        ...
        S = 1;//(dH_dX * P_pred * dH_dX.t()) + R_explicit;
}


//Implementation of the Update Function
void Explicit_Update(Mat X_pred, Mat P_pred, Mat Z_explicit, Mat Z_explicit_pred, Mat Pn, Mat Q, Mat R_explicit, Mat dF_dX, Mat dH_dX, Mat dF_dU, Mat &X_kplus1, Mat &P_kplus1){
...
void Implicit_Explicit_Update(Mat X_pred, Mat P_pred, Mat Z_explicit, Mat Z_explicit_pred, Mat Inn_implicit, Mat Pn, Mat Q, Mat R_explicit, Mat R_implicit, Mat dF_dX,Mat dH_dX, Mat dG_dX, Mat dF_dU, Mat &X_kplus1, Mat &P_kplus1){
...
void Implicit_Explicit_Update(Mat X_pred, Mat P_pred, Mat Z_explicit, Mat Z_explicit_pred, Mat Inn_implicit, Mat Pn, Mat Q, Mat R_explicit, Mat R_implicit, Mat dF_dX, Mat dH_dX, Mat dG_dX, Mat dF_dU, Mat &X_kplus1, Mat &P_kplus1, std::vector<double> &norm_inn_sq, bool &filter_converged, int norm_inn_sq_win, double convergence_threshold){
...
void Innovation_Update(Mat X_pred, Mat P_pred, Mat Inn, Mat Pn, Mat Q, Mat R, Mat dF_dX, Mat dInn_dX, Mat dF_dU, Mat &X_kplus1, Mat &P_kplus1){
...
void Innovation_Update(Mat X_pred, Mat P_pred, Mat Inn, Mat Pn, Mat Q, Mat R, Mat dF_dX, Mat dInn_dX, Mat dF_dU, Mat &X_kplus1, Mat &P_kplus1, std::vector<double> &mean_inn_vec, bool &filter_converged, int mean_inn_samples, double convergence_threshold){
